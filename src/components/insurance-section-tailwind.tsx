...
export default function InsuranceSectionTailwind() {
  return (
        ...
        <div className="bg-[#12121a] border border-gray-800 rounded-2xl p-8 md:p-12">
          ...
          <div className="mb-6">
            <div className="flex flex-row items-center gap-4">
              ...
              <h2 className="font-teko text-4xl font-bold text-white m-0 leading-none">
                LICENSED & INSURED
              </h2>
            </div>
            <p className="m-0 mt-3 ml-16 text-gray-400">
            ...
            {coverageItems.map((item) => (
              ...
              >
                <div className="flex flex-row items-center gap-2.5">
                  <Check className="w-[18px] h-[18px] text-cyan-400 shrink-0" />
                  <p className="m-0 text-white font-medium leading-none">{item.title}</p>
                </div>
                <p className="m-0 mt-2 ml-7 text-gray-500 text-sm">{item.description}</p>
              </div>
            ))}
          </div>
