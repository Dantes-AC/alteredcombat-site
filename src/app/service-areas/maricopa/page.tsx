...
export const metadata = {
  ...
  keywords: [
    ...
    "birthday party Maricopa",
    "party games Maricopa",
    "kids party Maricopa",
  ],
};
      ...
      <section className="py-20 bg-gradient-to-b from-[#12121a] to-[#0a0a0f]">
        <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="font-teko text-4xl sm:text-5xl font-bold text-white mb-6">
            READY TO PLAY IN MARICOPA?
          </h2>
          <p className="text-xl text-gray-300 mb-8">
            Make your next party the best one on the block. Book today.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a
              href={BOOKING_URL}
